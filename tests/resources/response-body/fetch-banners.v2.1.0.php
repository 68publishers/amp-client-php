...
return new BannersResponse(
    ...
    [
        ...
        'homepage.with-no-content-breakpoint' => new Position(
            '779ea214-025f-4e9d-ba7b-bc9e16a2516c',
            'homepage.with-no-content-breakpoint',
            'Homepage - with no content breakpoint',
            5,
            Position::DisplayTypeSingle,
            Position::BreakpointTypeMin,
            ...
            [
                new Banner(
                    '4906bdd6-68c9-4633-baf0-7d7a1abb5188',
                    'Homepage with no content breakpoint',
                    0,
                    '47d4cd61-acbe-4323-98fa-1ac06b7d093f',
                    'test-campaign',
                    'Test campaign',
                    86400,
                    [
                        ...
                        new HtmlContent(
                            500,
                            '<div class="alert alert-info w-100">Content from 500px</div>',
                        ),
                    ],
                ),
            ],
